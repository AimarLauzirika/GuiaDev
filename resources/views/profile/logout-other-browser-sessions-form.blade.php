<x-jet-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario, puedes cerrar sesión en todas las sesiones de todos tus dispositivos. Algunas de tus últimas sesiones están listados debajo; sin embargo, esta lista puede que no sea exhaustiva. Si crees que tu cuenta a sido comprometida, deberías cambiar tu contraseña.') }}
        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por favor introduce tu contraseña para confirmar que quieres cerrar sesión en los demás navegadores.') }}
